...
[📧 Email](mailto:valyndsilva@gmail.com)
...
* Reflection-based agent workflows for iterative research and self-correction
* Multi-provider architecture supporting Anthropic, OpenAI, and Google models
* Embedding-powered retrieval using pgvector
* Model-split strategy reducing LLM costs by **75%**
...
* Multi-tenant architecture with subscription billing and RBAC
* AI-powered CV analysis, interview preparation, job recommendations, and skills-gap assessment
* Authentication, profile management, and role-based access control
* End-to-end SaaS workflows spanning onboarding, subscriptions, and candidate journeys
...
> Product Engineer focused on building reliable, user-centred products.
